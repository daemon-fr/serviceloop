...
import com.v16studio.v16service.data.BusinessProfileEntity
...
import com.v16studio.v16service.data.FollowUpEntity
import com.v16studio.v16service.data.V16ServiceDao
...
object FixtureSeederFactory {
    ...
    fun createFixtureSeeder(database: V16ServiceDatabase): StartupSeeder = DebugFixtureSeeder(database)
}

private class DebugFixtureSeeder(private val database: V16ServiceDatabase) : StartupSeeder {
    ...
    private suspend fun seedOwnerReviewVisit(dao: V16ServiceDao, created: Long) {
