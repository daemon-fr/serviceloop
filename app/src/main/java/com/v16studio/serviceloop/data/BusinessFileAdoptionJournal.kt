...
internal class BusinessFileAdoptionJournal private constructor(
    ...
    companion object {
        ...
        fun begin(database: ServiceLoopDatabase, root: File, planned: Map<String, ByteArray>): BusinessFileAdoptionJournal {
        ...
        fun recoverInterrupted(database: ServiceLoopDatabase, root: File): Boolean {
            val file = journalFile(root)
        ...
        private fun adoptionIdentity(database: ServiceLoopDatabase): Pair<String, String> =
        ...
        private fun referenceCount(database: ServiceLoopDatabase, path: String): Int {
