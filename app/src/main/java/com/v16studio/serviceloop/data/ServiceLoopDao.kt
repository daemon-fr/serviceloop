...
interface ServiceLoopDao {
    ...
    @Query("UPDATE remote_final_results SET sourcePayloadJson=:snapshot WHERE id=:id AND sourcePayloadJson IS NULL")
    suspend fun recoverRemoteSourceSnapshot(id: String, snapshot: String): Int
