...
@Composable
fun V16ServiceInspectionStatusGrid(
    ...
    SubcomposeLayout(modifier.fillMaxWidth()) { constraints ->
        ...
        val gapPx = V16ServiceUiTokens.Layout.pairGap.roundToPx()
...
private fun InspectionStatusChoiceSurface(
    ...
    Surface(
        ...
        border = BorderStroke(
            V16ServiceUiTokens.Stroke.outline,
            if (selected) semanticColor.copy(alpha = 0.75f) else colors.outlineControl,
        ),
    ) {
        Row(
            Modifier.fillMaxWidth().padding(horizontal = V16ServiceUiTokens.Space.sm, vertical = V16ServiceUiTokens.Space.sm),
            ...
            V16ServiceIcon(
                ...
                modifier = Modifier.size(V16ServiceUiTokens.Size.iconSmall),
