...
data class V16ServiceScopeFilter(
    ...
    fun withCustomer(id: String?): V16ServiceScopeFilter = if (id == customerId) this else copy(customerId = id, siteId = null, equipmentId = null)

    fun withSite(id: String?): V16ServiceScopeFilter {
    ...
    fun withEquipment(id: String?): V16ServiceScopeFilter {
