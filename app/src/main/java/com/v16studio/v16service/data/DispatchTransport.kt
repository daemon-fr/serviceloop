...
object DispatchPackageCodec {
    ...
    fun encode(value: DispatchPackage): ByteArray {
        ...
        val root = JSONObject().put("format", "V16ServiceWorkPackage").put("formatVersion", CURRENT_VERSION).put("packageId", value.packageId).put("createdAt", value.createdAt).put("senderLabel", value.senderLabel)
    ...
    fun decode(bytes: ByteArray): DispatchPackage {
        ...
        require(root.optString("format") == "V16ServiceWorkPackage") { "Not a V16 Service work package" }; val version = root.optInt("formatVersion", -1); require(version == CURRENT_VERSION) { "Unsupported work package version" }
...
data class AssignedVisitInput(
    val siteId: String?,
    val newCustomerSite: com.v16studio.v16service.domain.CustomerWithFirstSiteInput?,
    val planIds: List<String>,
    val tasks: List<com.v16studio.v16service.domain.AdHocWorkInput>,
    val serviceDate: String,
