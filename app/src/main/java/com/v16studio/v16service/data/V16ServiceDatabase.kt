...
@Database(
    entities = [
        ...
        TechnicianIdentityEntity::class, TrustedV16ServiceIdEntity::class, DispatchTechnicianEntity::class,
...
abstract class V16ServiceDatabase : RoomDatabase() {
    abstract fun v16ServiceDao(): V16ServiceDao
    abstract fun dispatchDao(): DispatchDao

    companion object {
        fun open(context: Context): V16ServiceDatabase = Room.databaseBuilder(
