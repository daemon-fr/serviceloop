...
class V16ServicePresetChoiceLayoutTest {
            ...
            CompositionLocalProvider(LocalDensity provides Density(1f, 2f)) {
                V16ServiceTheme {
                    Box(Modifier.width(320.dp).testTag("large-text-presets")) {
                        V16ServicePresetChoiceGroup(options, 3, {}, testTagPrefix = "large-text-preset")
                    }
                }
            }
        }
        ...
        compose.setContent {
            V16ServiceTheme {
                Box(Modifier.width(360.dp)) {
                    V16ServicePresetChoiceGroup(options, "MONTHS", {}, testTagPrefix = "interval-unit", singleRow = true)
                }
            }
        }
