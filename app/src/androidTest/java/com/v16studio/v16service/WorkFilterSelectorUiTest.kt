...
import com.v16studio.v16service.ui.FollowUpsWorkScreen
...
import com.v16studio.v16service.ui.VisitsWorkScreen
...
class WorkFilterSelectorUiTest {
    ...
    fun clearPersistedFilterPreferences() {
        compose.activity.applicationContext
            .getSharedPreferences("v16service_ui_filter_preferences", android.content.Context.MODE_PRIVATE)
            .edit()
            .clear()
            .commit()
    }
    ...
    @Test fun darkAppearanceKeepsDarkSelectorMenuInteractionReadable() {
        ...
        compose.runOnUiThread {
            compose.activity.setContent {
                V16ServiceTheme(darkTheme = true) {
                    DueServicesScreen(
