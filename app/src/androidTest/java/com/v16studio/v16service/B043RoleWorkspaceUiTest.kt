...
import com.v16studio.v16service.ui.TEAM_ROLE_OPTIONS
...
class B043RoleWorkspaceUiTest {
    ...
    @Test fun coordinatorCanCreateVisitButCannotPerformFieldWorkAndEmployeeCannotCreateVisit() {
        compose.runOnUiThread {
            ...
            compose.activity.setContent { V16ServiceTheme(false) { V16ServiceApp(viewModel, "inspection/not-a-work-item") } }
        }
        ...
        compose.runOnUiThread {
            val application = compose.activity.application as V16ServiceApplication
            val viewModel = V16ServiceViewModel(application.container.repository) {}
            compose.activity.setContent { V16ServiceTheme(false) { V16ServiceApp(viewModel, "visit/new") } }
        }
