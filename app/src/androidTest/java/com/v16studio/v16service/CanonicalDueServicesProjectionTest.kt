...
class CanonicalDueServicesProjectionTest {
    ...
    @Test fun preservedProjectionRemainsStableAcrossAdversarialRootNavigation() = runBlocking {
        ...
        val app = InstrumentationRegistry.getInstrumentation().targetContext.applicationContext as V16ServiceApplication
        ...
        val viewModel = V16ServiceViewModel(app.container.repository) { app.container.startup.await() }
