...
class B048PhotoManagementUiTest {
    ...
    private class EmptyRepository : ServiceLoopRepository {
        override suspend fun home() = com.v16studio.serviceloop.domain.HomeSummary(null, null, null, null, null, null, null, 0, null, null, 0, 0)
        override suspend fun equipment(id: String) = null
        override suspend fun equipmentList(): List<com.v16studio.serviceloop.domain.EquipmentSummary> = emptyList()
        override suspend fun customerList(): List<com.v16studio.serviceloop.domain.CustomerSummary> = emptyList()
        override suspend fun inspection(workItemId: String): com.v16studio.serviceloop.domain.InspectionDraft? = null
        override suspend fun completionLines(visitId: String): List<com.v16studio.serviceloop.domain.CompletionLine> = emptyList()
        override suspend fun saveResponse(workItemId: String, questionId: String, disposition: com.v16studio.serviceloop.domain.ResponseDisposition, value: String?, reason: String?) = 0L
        override fun observeDueServices(): Flow<List<com.v16studio.serviceloop.domain.DueService>> = emptyFlow()
    }
}
