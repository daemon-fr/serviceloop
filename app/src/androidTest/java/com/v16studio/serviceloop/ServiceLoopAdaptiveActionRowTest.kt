...
class ServiceLoopAdaptiveActionRowTest {
                ...
                LazyColumn(Modifier.fillMaxSize().testTag("unbounded-action-list")) {
                    item {
                        ServiceLoopAdaptiveActionRow(
                            actions = listOf({ ServiceLoopSecondaryButton("Open", {}, Modifier.testTag("single-action")) }),
                    ...
                    item {
                        ServiceLoopAdaptiveActionRow(
                            actions = listOf(
                                { ServiceLoopSecondaryButton("Open", {}, Modifier.testTag("two-action-first")) },
                                { ServiceLoopPrimaryButton("Clear", {}, Modifier.testTag("two-action-second")) },
                            ),
                    ...
                    item {
                        ServiceLoopAdaptiveActionRow(
                            actions = listOf(
                                { ServiceLoopSecondaryButton("Book", {}, Modifier.testTag("three-action-first")) },
                                { ServiceLoopPrimaryButton("Start", {}, Modifier.testTag("three-action-second")) },
                                { ServiceLoopSecondaryButton("Clear", {}, Modifier.testTag("three-action-third")) },
                            ),
