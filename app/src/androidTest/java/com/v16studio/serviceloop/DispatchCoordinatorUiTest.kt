...
class DispatchCoordinatorUiTest {
    ...
    @Test fun renderedEditorAndExportReviewExposeSeparateWorkflowSurfaces(){
        ...
        try{
            ...
            compose.onNodeWithTag("open-render-editor").performClick();compose.onNodeWithTag("dispatch-new-visit").performScrollToNode(hasTestTag("visit-site-render-site"));compose.onNodeWithTag("visit-site-render-site").performClick()
