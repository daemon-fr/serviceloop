...
class DispatchCoordinatorUiTest {
    ...
    @Test fun coordinatorWorkspaceMovesFromSettingsToReactiveHomeActions(){
        ...
        compose.onNodeWithText("Outbox").performClick();compose.onNodeWithTag("dispatch-outbox").assertIsDisplayed();compose.onNodeWithTag("dispatch-new-visit-floating").performClick();compose.onNodeWithTag("dispatch-new-visit").assertIsDisplayed()
        compose.onNodeWithTag("dispatch-save-visit").assertIsEnabled().performClick();compose.onNodeWithTag("dispatch-new-visit").performScrollToNode(hasText("Choose a Site."));compose.onNodeWithText("Choose a Site.").assertIsDisplayed()
