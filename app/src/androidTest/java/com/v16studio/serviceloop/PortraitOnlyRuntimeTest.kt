...
class PortraitOnlyRuntimeTest {
    ...
    @Test
    fun autoRotateAndDeviceRotationKeepServiceLoopPortrait() {
    ...
    private fun assertPortraitWindow() {
        ...
        assertTrue("ServiceLoop must remain portrait: ${bounds.width()}x${bounds.height()}", bounds.height() >= bounds.width())
    }
}
