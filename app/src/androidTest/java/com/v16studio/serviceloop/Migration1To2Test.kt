...
class Migration1To2Test {
    ...
    @Test fun migrationOneToSevenPreservesRowsThroughTheRegisteredChain() {
        ...
        val migrated = Room.databaseBuilder(context, ServiceLoopDatabase::class.java, dbName).addMigrations(ServiceLoopDatabase.MIGRATION_1_2, ServiceLoopDatabase.MIGRATION_2_3, ServiceLoopDatabase.MIGRATION_3_4, ServiceLoopDatabase.MIGRATION_4_5, ServiceLoopDatabase.MIGRATION_5_6, ServiceLoopDatabase.MIGRATION_6_7, ServiceLoopDatabase.MIGRATION_7_8).build()
        try {
    ...
    @Test fun migrationTwoToSevenBackfillsWorkingSnapshotsAndPreservesFinalReportAndObligation() {
        ...
        val migrated = Room.databaseBuilder(context, ServiceLoopDatabase::class.java, dbName).addMigrations(ServiceLoopDatabase.MIGRATION_2_3, ServiceLoopDatabase.MIGRATION_3_4, ServiceLoopDatabase.MIGRATION_4_5, ServiceLoopDatabase.MIGRATION_5_6, ServiceLoopDatabase.MIGRATION_6_7, ServiceLoopDatabase.MIGRATION_7_8).build()
    ...
    @Test fun migrationThreeToSevenPreservesDailyWorkAndBackfillsActiveClaim() {
        ...
        val migrated=Room.databaseBuilder(context,ServiceLoopDatabase::class.java,dbName).addMigrations(ServiceLoopDatabase.MIGRATION_3_4, ServiceLoopDatabase.MIGRATION_4_5, ServiceLoopDatabase.MIGRATION_5_6, ServiceLoopDatabase.MIGRATION_6_7, ServiceLoopDatabase.MIGRATION_7_8).build()
    ...
    @Test fun migrationFourToSevenPreservesDirectoryAndCreatesRecoveryFoundation() {
        ...
        val migrated=Room.databaseBuilder(context,ServiceLoopDatabase::class.java,dbName).addMigrations(ServiceLoopDatabase.MIGRATION_4_5, ServiceLoopDatabase.MIGRATION_5_6, ServiceLoopDatabase.MIGRATION_6_7, ServiceLoopDatabase.MIGRATION_7_8).build()
