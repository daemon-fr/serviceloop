...
class Migration1To2Test {
    ...
    @Test fun migrationOneToFivePreservesRowsThroughTheRegisteredChain() {
        ...
        val migrated = Room.databaseBuilder(context, ServiceLoopDatabase::class.java, dbName).addMigrations(ServiceLoopDatabase.MIGRATION_1_2, ServiceLoopDatabase.MIGRATION_2_3, ServiceLoopDatabase.MIGRATION_3_4, ServiceLoopDatabase.MIGRATION_4_5, ServiceLoopDatabase.MIGRATION_5_6).build()
        try {
    ...
    @Test fun migrationTwoToFiveBackfillsWorkingSnapshotsAndPreservesFinalReportAndObligation() {
        ...
        val migrated = Room.databaseBuilder(context, ServiceLoopDatabase::class.java, dbName).addMigrations(ServiceLoopDatabase.MIGRATION_2_3, ServiceLoopDatabase.MIGRATION_3_4, ServiceLoopDatabase.MIGRATION_4_5, ServiceLoopDatabase.MIGRATION_5_6).build()
    ...
    @Test fun migrationThreeToFivePreservesDailyWorkAndBackfillsActiveClaim() {
        ...
        val migrated=Room.databaseBuilder(context,ServiceLoopDatabase::class.java,dbName).addMigrations(ServiceLoopDatabase.MIGRATION_3_4, ServiceLoopDatabase.MIGRATION_4_5, ServiceLoopDatabase.MIGRATION_5_6).build()
