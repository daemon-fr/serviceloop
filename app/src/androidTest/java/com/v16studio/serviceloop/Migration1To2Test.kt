...
class Migration1To2Test {
    ...
    @Test fun migrationNineToTenBackfillsOnlyActiveModeReasonDraft() {
        ...
        val migrated=Room.databaseBuilder(context,ServiceLoopDatabase::class.java,dbName).addMigrations(ServiceLoopDatabase.MIGRATION_9_10,ServiceLoopDatabase.MIGRATION_10_11,ServiceLoopDatabase.MIGRATION_11_12).build()
    ...
    @Test fun migrationElevenToTwelveNormalizesVisitLifecycleAndAddsCancellationColumns() {
        ...
        val migrated=Room.databaseBuilder(context,ServiceLoopDatabase::class.java,dbName).addMigrations(ServiceLoopDatabase.MIGRATION_11_12).build()
