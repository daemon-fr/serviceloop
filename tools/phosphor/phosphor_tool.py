#!/usr/bin/env python3
"""Verify the vendored Phosphor tree and generate V16Service VectorDrawables."""
...
MANIFEST = ROOT / "v16service-icons.json"
OUTPUT = ROOT.parent.parent / "app" / "src" / "main" / "res" / "drawable"
API = ROOT.parent.parent / "app" / "src" / "main" / "java" / "com" / "v16studio" / "v16service" / "ui" / "icons" / "V16ServiceIcons.kt"
...
def generate() -> None:
    ...
    for old in OUTPUT.glob("ic_v16s_*.xml"):
